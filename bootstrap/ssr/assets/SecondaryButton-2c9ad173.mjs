      ...
      children: [
        /* @__PURE__ */ jsx(
          Transition.Child,
          {
            ...
            leaveTo: "opacity-0",
            children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gray-500/75 dark:bg-darker/75" })
          }
        ),
        /* @__PURE__ */ jsx(
          Transition.Child,
          {
            ...
            children: /* @__PURE__ */ jsx(
              Dialog.Panel,
              {
                className: `mb-6 bg-white dark:bg-dark rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto ${maxWidthClass}`,
                children
              }
            )
          }
...
function SecondaryButton({ type = "button", className = "", disabled, children, ...props }) {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...props,
      type,
      className: `btn-secondary ${px} ${py} disabled:opacity-25 transition ease-in-out duration-150 ${disabled && "opacity-25"} ` + className,
      disabled,
      children
    }
  );
