...
function Stars({ rating }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center", children: [
    Array.from({ length: parseInt(rating) }).map(() => /* @__PURE__ */ jsx(
      "svg",
      {
        "aria-hidden": "true",
    ...
    Array.from({ length: parseInt(5 - Math.floor(rating)) }).map(() => /* @__PURE__ */ jsx(
      "svg",
      {
        "aria-hidden": "true",
    ...
    /* @__PURE__ */ jsx("span", { className: "bg-primary/20 text-primary text-xs font-semibold ml-2 px-2.5 py-0.5 rounded", children: rating })
  ] });
}
export {
  Stars as S
